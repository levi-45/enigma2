...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "oZeta-FHD/skin.xml" or "FullNightHD/skin.xml"  # SD hardware is no longer supported by the default skin.
