...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "Aglare-FHD-PLI/skin.xml" or "oZeta-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
